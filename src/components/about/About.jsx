...
export const About = () => {
    return (
        <div className='container-about'>
            ...
            <p className='text-about'>¡Hola! Somos Nora y Ana, madre e hija. Llegamos a Uruguay desde nuestra querida Venezuela. Aquí, hemos descubierto con alegría que a la gente le encanta descubrir sabores y experiencias nuevas. Por eso, y porque quisimos traerte un pedacito de nuestra cultura y de la cocina caribeña, en 2018 fundamos Cachitos Bakery, un emprendimiento familiar y artesanal. </p>
